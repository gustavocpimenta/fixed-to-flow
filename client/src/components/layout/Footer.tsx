                    ...
                    <FormItem className="text-left">
                      ...
                      <FormControl>
                        <Input 
                          ...
                          className="bg-gray-800 border-gray-700 focus:border-gray-700 !focus-visible:ring-gray-700 !focus-visible:ring-offset-0 !focus-visible:ring-1 text-white [&:-webkit-autofill]:!bg-gray-800 [&:-webkit-autofill]:!text-white [&:-webkit-autofill_-webkit-text-fill-color]:!text-white [&:-webkit-autofill]:!shadow-[0_0_0_30px_rgb(31,41,55)_inset] focus:bg-gray-800 selection:bg-gray-700 focus:!outline-none selection:!bg-gray-700 selection:!text-white focus-visible:!ring-gray-700 focus:!ring-gray-700 !ring-gray-700 !ring-offset-0" 
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                    ...
                    <FormItem className="text-left">
                      ...
                      <FormControl>
                        <Textarea 
                          ...
                          className="min-h-[120px] bg-gray-800 border-gray-700 focus:border-gray-700 !focus-visible:ring-gray-700 !focus-visible:ring-offset-0 !focus-visible:ring-1 text-white [&:-webkit-autofill]:!bg-gray-800 [&:-webkit-autofill]:!text-white [&:-webkit-autofill_-webkit-text-fill-color]:!text-white [&:-webkit-autofill]:!shadow-[0_0_0_30px_rgb(31,41,55)_inset] focus:bg-gray-800 selection:bg-gray-700 focus:!outline-none selection:!bg-gray-700 selection:!text-white focus-visible:!ring-gray-700 focus:!ring-gray-700 !ring-gray-700 !ring-offset-0" 
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
          ...
          <div className="space-y-8 relative">
            ...
            >
              ...
              <p className="text-lg text-gray-300 mb-8">
                From intimate dinners to personal tools, a grounded ecosystem for connection, reflection, and growth.</p>
            ...
            <div className="mt-20 md:mt-16 py-6 border-t border-gray-800">
              <div className="flex justify-center md:justify-end space-x-6 mb-4">
                <a href="https://www.linkedin.com/company/fixedtoflow/" className="text-gray-400 hover:text-gray-300">
                ...
                <a href="https://x.com/fixedtoflow" className="text-gray-400 hover:text-gray-300">
                  <span className="sr-only">X</span>
                  <svg className="h-[17px] w-[17px]" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/fixedtoflow/" className="text-gray-400 hover:text-gray-300">
