      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-center mb-12">At <span className="font-semibold text-primary">Fixed to Flow</span>, adaptability isn't just a skill—it's a shared journey.</p>
          </motion.div>
